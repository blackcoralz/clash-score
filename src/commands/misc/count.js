...
module.exports = {
    name: 'count',
        ...
        options: [
            ...
            {
                name:'number',
                description: 'How much member need to contribute #20 * [number]',
    ...
    callback: async (client, interaction) => {
        ...
        if (is_found) {
            ...
            const personal = clashinfo["20personal"];
