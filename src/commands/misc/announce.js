    ...
    callback: async (client, interaction) => {
      ...
      getCLASHSCORE((data) => {
        ...
        if (is_found) {
            ...
            const channel = client.channels.cache.get('995970684276707369');
            ...
            channel.send({ embeds: [embedclash]})
            interaction.editReply(`embed is ready to announce at <#${channel.id}>.`);
